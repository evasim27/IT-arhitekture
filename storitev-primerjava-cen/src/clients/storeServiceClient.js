    ...
    this.pricesByProduct =
      pricesByProduct || {
        "1": [
          ...
          { store_id: 3, store_name: "Mercator", price: 7.29, currency: "EUR" },
        ],
        "2": [
          { store_id: 4, store_name: "Tus", price: 2.19, currency: "EUR" },
          { store_id: 2, store_name: "Spar", price: 2.29, currency: "EUR" },
        ],
        "3": [],
      };
  }
